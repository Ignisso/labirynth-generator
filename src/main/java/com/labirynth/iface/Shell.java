...
public class Shell {
    ...
    */
	...
	public void printHelp() {
		System.out.println("COMMAND <REQUIRED> [OPTIONAL]\n");
		...
		System.out.println("set size <width> <height>		set width and height current labirynth");
		System.out.println("print					prints labirynth");
		System.out.println("generate [seed]				generates new labirynt");
		System.out.println("solve					solves labirynth");
		System.out.println("write <bitmap/text/binary> <path>	write specified file type to path");
		System.out.println("read  <bitmap/text/binary> <path>	read specified file type from path");
	}
}
